     ...
     //   tv_timer.setVisibility(View.GONE);
        ...
        iv_yt_logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = YouTubeStandalonePlayer.createVideoIntent(TimerActivity.this, "AIzaSyAxbFLuWoJQLEf1CoKz5Y_zr25shENIOrQ",MainActivity.vidourl,1, true,true);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.img_bck:
                ...
                Intent intnt = new Intent(TimerActivity.this, MainActivity.class);
                startActivity(intnt);
                finish();
            ...
            case R.id.img_timer:
                ...
                tv.setText("Congrats!");
                simpleChronometer.setText("00:00:00");
                rel_timerbck.setBackgroundResource(R.drawable.back_texture);
