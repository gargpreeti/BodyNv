...
//            Log.e("======",mDecoratedChildHeight+"===="+mDecoratedChildWidth);
...
//                    Math.round(end + transformation.mTranslationX), Math.round(bottom + transformation.mTranslationY));
            ...
            Log.e("====tra",transformation.mScaleX+"====="+transformation.mScaleY);


                if (transformation.mScaleX == 1.0f) {
                    ViewCompat.setScaleX(view, transformation.mScaleX);
                    ViewCompat.setScaleY(view, transformation.mScaleY);
                } else if (transformation.mScaleX >= 0.5) {
                    ViewCompat.setScaleX(view, transformation.mScaleX + 0.35f);
                    ViewCompat.setScaleY(view, transformation.mScaleY);
                } else {
                    ViewCompat.setScaleX(view, transformation.mScaleX + 0.40f);
                    ViewCompat.setScaleY(view, transformation.mScaleY + 0.40f);
                }
